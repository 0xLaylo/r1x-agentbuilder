...
- 574e9b0: # Solana Payment Network Support
  ...
  - Examples:
    - `bunx @r1x/create-agent-kit my-agent --network=solana-devnet`
    - `bunx @r1x/create-agent-kit my-agent --network=solana`
...
- 1509e59: # Major Refactor: Template-Based Architecture with Adapter Support
  ...
  This release introduces a comprehensive refactor of the r1x-agent-sdk framework to support multiple runtime adapters and a flexible template system.
  ...
  - **Hono Adapter** (`@r1x/agent-kit-hono`): Traditional HTTP server adapter
  - **TanStack Start Adapter** (`@r1x/agent-kit-tanstack`): Full-stack React framework adapter with:
  ...
  // After
  import { createAgentApp } from '@r1x/agent-kit-hono';
  ```
  ...
  ```bash
  # Hono adapter
  bunx @r1x/create-agent-kit my-agent --adapter=hono

  # TanStack with UI (full dashboard)
  bunx @r1x/create-agent-kit my-agent --adapter=tanstack-ui

  # TanStack headless (API only)
  bunx @r1x/create-agent-kit my-agent --adapter=tanstack-headless
  ```

### Patch Changes

- Updated dependencies [1509e59]
  - @r1x/agent-kit-identity@1.3.0
  - @r1x/agent-core@0.2.0
...
- 069795f: AI agent optimization and documentation enhancement
  ...
  ```bash
  bunx @r1x/create-agent-kit my-agent \
    --template=identity \
    --non-interactive \
...
- Updated dependencies
  - @r1x/agent-kit-identity@0.2.24
  - @r1x/agent-auth@0.2.24
...
- Updated dependencies
  - @r1x/agent-auth@0.2.23
  - @r1x/agent-kit-identity@0.2.23
...
- fix favicon
- Updated dependencies
  - @r1x/agent-kit-identity@0.2.22
  - @r1x/agent-auth@0.2.22
...
- fix hot
- Updated dependencies
  - @r1x/agent-auth@0.2.21
  - @r1x/agent-kit-identity@0.2.21
...
- Updated dependencies
  - @r1x/agent-kit-identity@0.2.20
  - @r1x/agent-auth@0.2.20
...
- Updated dependencies [c023ca0]
  - @r1x/agent-kit-identity@0.2.19
  - @r1x/agent-auth@0.2.19
...
- Updated dependencies [f470d6a]
  - @r1x/agent-kit-identity@0.2.18
  - @r1x/agent-auth@0.2.18
...
- bump
- Updated dependencies
  - @r1x/agent-kit-identity@0.2.17
  - @r1x/agent-auth@0.2.17
...
- up
- Updated dependencies
  - @r1x/agent-kit-identity@0.2.16
  - @r1x/agent-auth@0.2.16
...
- Updated dependencies [be4c11a]
  - @r1x/agent-kit-identity@0.2.15
  - @r1x/agent-auth@0.2.15
...
- Updated dependencies
- Updated dependencies
  - @r1x/agent-auth@0.2.14
  - @r1x/agent-kit-identity@0.2.14
