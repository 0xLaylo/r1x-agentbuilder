...
```bash
bunx @r1x/create-agent-kit@latest my-agent
```
...
```bash
bunx @r1x/create-agent-kit <app-name> [options]
...
bunx @r1x/create-agent-kit@latest my-agent --template=identity

# With Solana payment network
bunx @r1x/create-agent-kit@latest my-agent --network=solana-devnet

# With Base mainnet
bunx @r1x/create-agent-kit@latest my-agent --network=base

# Identity template with Solana payments
bunx @r1x/create-agent-kit@latest my-agent --template=identity --network=solana

# With Hono adapter
bunx @r1x/create-agent-kit@latest my-agent --adapter=hono --template=blank

# With TanStack UI (full dashboard)
bunx @r1x/create-agent-kit@latest my-agent --adapter=tanstack-ui --template=blank

# With TanStack headless (API only, no UI)
bunx @r1x/create-agent-kit@latest my-agent --adapter=tanstack-headless --template=blank

# Auto-install dependencies
bunx @r1x/create-agent-kit@latest my-agent --install

# Non-interactive with defaults
bunx @r1x/create-agent-kit@latest my-agent --template=blank --wizard=no
```
...
```bash
# Solana devnet
bunx @r1x/create-agent-kit my-agent --network=solana-devnet --non-interactive

# Base mainnet
bunx @r1x/create-agent-kit my-agent --network=base --non-interactive
```
...
bunx @r1x/create-agent-kit@latest verified-agent \
  --template=identity \
  --non-interactive \
  --install \
  ...
  --PAYMENTS_FACILITATOR_URL="https://facilitator.payai.network" \
...
# AxLLM template
bunx @r1x/create-agent-kit@latest ai-agent \
  --template=axllm \
  --non-interactive \
...
- [`@r1x/agent-kit`](../agent-kit/README.md) - Core agent runtime
- [`@r1x/agent-kit-identity`](../agent-kit-identity/README.md) - ERC-8004 identity
