...
This is a minimal Bun HTTP agent built with `@r1x/agent-kit`. It provides a simple starting point with basic entrypoint configuration and optional payment support.
...
- Import types from `@r1x/agent-kit/types`
...
- [@r1x/agent-kit documentation](../../../agent-kit/README.md)
