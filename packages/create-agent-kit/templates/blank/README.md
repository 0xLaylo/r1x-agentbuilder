...
This project was scaffolded with `create-agent-kit` and ships with a ready-to-run agent app built on [`@r1x/agent-kit`](https://www.npmjs.com/package/@r1x/agent-kit).
...
- Wire up `@r1x/agent-kit` configuration and secrets (see `AGENTS.md` in the repo for details).
