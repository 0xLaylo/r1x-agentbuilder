...
This is a Bun HTTP agent with `@ax-llm/ax` integration for LLM-powered capabilities. It includes payment support via x402 and uses `@r1x/agent-kit` for agent app creation.
...
```typescript
import { createAxLLMClient } from "@r1x/agent-kit";
...
- [@r1x/agent-kit docs](../../../agent-kit/README.md)
