...
This project was scaffolded with `create-agent-kit` and includes **ERC-8004 identity registration** built on [`@r1x/agent-kit`](https://www.npmjs.com/package/@r1x/agent-kit) and [`@r1x/agent-kit-identity`](https://www.npmjs.com/package/@r1x/agent-kit-identity).
...
- [Agent Kit Documentation](https://github.com/0xLaylo/r1x-agent-sdk/blob/master/packages/agent-kit/README.md)
- [Identity Kit Documentation](https://github.com/0xLaylo/r1x-agent-sdk/blob/master/packages/agent-kit-identity/README.md)
