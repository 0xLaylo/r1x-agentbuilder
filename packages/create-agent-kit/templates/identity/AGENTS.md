...
This is a Bun HTTP agent with ERC-8004 identity registration and trust metadata. It combines `@r1x/agent-kit` for the agent framework and `@r1x/agent-kit-identity` for on-chain identity management.
...
**Key Dependencies:**
- `@r1x/agent-kit` - Agent app framework
- `@r1x/agent-kit-identity` - ERC-8004 identity helpers
...
- [@r1x/agent-kit-identity docs](../../../agent-kit-identity/README.md)
