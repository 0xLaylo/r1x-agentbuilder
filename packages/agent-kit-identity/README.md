...
ERC-8004 identity helpers for r1x Agent SDK. Register your agent on the ERC-8004 registry and include verifiable on-chain identity in your agent manifest.
...
```bash
bun add @r1x/agent-kit-identity
```
...
```typescript
import { generateAgentMetadata } from '@r1x/agent-kit-identity';
...
- [ERC-8004 Reference Implementation](https://github.com/r1xlabs/erc-8004-contracts)
- [Agent Kit Documentation](https://github.com/0xLaylo/r1x-agent-sdk/tree/main/packages/agent-kit)
