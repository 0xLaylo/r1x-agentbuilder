...
import type { PaymentsConfig } from '@r1x/agent-kit';
...
describe('TanStack Solana Payments', () => {
  ...
  // The core validation logic is in @r1x/x402-tanstack-start (lines 143-179)
  ...
  it('creates paywall middleware for Solana network', () => {
    ...
    }) satisfies typeof import('@r1x/x402-tanstack-start').paymentMiddleware;
