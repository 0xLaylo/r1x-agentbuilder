# r1x Agent SDK Monorepo - AI Coding Guide

This guide helps AI coding agents understand and work with the r1x-agent-sdk monorepo effectively.

## Project Overview

This is a TypeScript/Bun monorepo for building, monetizing, and verifying AI agents. It provides:

- **@r1x/agent-kit** - Core framework for creating agent HTTP servers
- **@r1x/agent-kit-identity** - ERC-8004 identity and trust layer
- **@r1x/create-agent-kit** - CLI for scaffolding new agent projects
...
- **Hono** (`@r1x/agent-kit-hono`) - Traditional HTTP server
- **TanStack Start UI** (`@r1x/agent-kit-tanstack`) - Full-stack React with dashboard
...
```typescript
import { paymentsFromEnv } from '@r1x/agent-kit';
...
```typescript
import { createAgentIdentity } from '@r1x/agent-kit-identity';
...
```typescript
import { getTrustConfig } from '@r1x/agent-kit-identity';
...
import type { TrustConfig } from '@r1x/agent-kit-identity';
...
3. Using correct import paths (e.g., `@r1x/agent-kit/types`)
