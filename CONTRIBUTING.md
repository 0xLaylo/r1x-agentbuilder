# Contributing to r1x Agent SDK

Thank you for your interest in contributing to r1x Agent SDK! This document provides guidelines and instructions for contributing to the project.
...
```bash
git clone https://github.com/0xLaylo/r1x-agent-sdk.git
cd r1x-agent-sdk
```
